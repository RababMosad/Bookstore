@extends('theme.default')
 ...
 @section('content')
 <a  class="btn btn-primary" href="{{route('authors.create')}}"><i class="fas fa-plus">اضف مؤلفا جديدا !</i></a>
 <hr>
 <div class="row">
    <div class="col-md-12">
        ...
        <tr>
            ...
            @foreach($authors as $author)
                 <tr>
                    ...
                    <td>
                        <a  class="btn btn-info btn-sm" href="{{route('authors.edit' , $author)}}"> <i class="fa fa-edit">تعديل</i></a>
